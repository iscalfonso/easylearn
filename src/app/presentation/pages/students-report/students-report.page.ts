...
@Component({
  ...
  templateUrl: './students-report.page.html',
  styleUrls: ['./students-report.page.scss'],
})
export class StudentsReportPage implements OnInit {
  basicData: any;
  basicOptions: any;
  data: any;
  options: any;
  ...
  bars(){
    ...
    this.basicData = {
      ...
      datasets: [
        {
          label: 'Promedio por tarea de la asignatura',
          data: [7.5, 5, 8, 10],
          backgroundColor: [
            'rgba(255, 159, 64, 0.2)',
            'rgba(75, 192, 192, 0.2)',
